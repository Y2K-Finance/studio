...
@PositionTemplate()
export class ArbitrumY2KFinanceFarmContractPositionFetcher extends ContractPositionTemplatePositionFetcher<Contract> {
  groupLabel: string;

  constructor(
    @Inject(APP_TOOLKIT) protected readonly appToolkit: IAppToolkit,
    @Inject(Y2KFinanceContractFactory) protected readonly y2KFinanceContractFactory: Y2KFinanceContractFactory,
  ) {
    super(appToolkit);
  }
