...
import type { Lock32Rewards, Lock32RewardsInterface } from '../Lock32Rewards';
...
export class Lock32Rewards__factory {
  static readonly abi = _abi;
  static createInterface(): Lock32RewardsInterface {
    return new utils.Interface(_abi) as Lock32RewardsInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Lock32Rewards {
    return new Contract(address, _abi, signerOrProvider) as Lock32Rewards;
  }
}
